 ...
 * 'commerce_multistore_product_variation_attributes' widget.
 *
 * @FieldWidget(
 *   id = "commerce_multistore_product_variation_attributes",
 *   label = @Translation("Multistore product variation attributes"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
 */
class MultistoreProductVariationAttributesWidget extends ProductVariationWidgetBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new MultistoreProductVariationAttributesWidget object.
   *
